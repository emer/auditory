...
func (dft *Dft) Filter(ch int, step int, windowIn etensor.Float32, firstStep bool, powerForTrial *etensor.Float32, logPowerForTrial *etensor.Float32) {
	...
	dft.Input(windowIn)
	dft.CompPower(ch, step, firstStep, powerForTrial, logPowerForTrial)
}
...
// PowerOfDft
func (dft *Dft) CompPower(ch, step int, firstStep bool, powerForTrial *etensor.Float32, logPowerForTrial *etensor.Float32) {
