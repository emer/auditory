...
func (mdl *Model) Reset() {
	mdl.Categories = Categories[:0]
	mdl.Params = Params[:0]
	mdl.Codes = Codes[:0]
	mdl.Postures = Postures[:0]
	mdl.Rules = Rules[:0]
	mdl.EquationGrps = EquationGrps[:0]
	mdl.TransitionGrps = TransitionGrps[:0]
	mdl.TransitionGrpsSp = TransitionGrpsSp[:0]
	mdl.Formula.Clear()
}
